...
3. For 50mL samples, aliquot samples to sample vials to reach just under the blue fill line (fill line indicates ~40-50mL).
    - Blue fill line will fade over time and must be manually drawn on again with Sharpie.
4. Cover sample vials, first with Titrator aluminum foil square, then with a white lid.
