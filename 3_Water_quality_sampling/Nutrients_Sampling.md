...
# Standard Protocol for Nutrients Sampling 
**Author(s):** Xin Diesel  
...
-	Bottle with Nutrients Sampling (bottle modified for nutrient sampling)
    a. There is a small hole in the bottom of the bottle to promote water flow
-	Amber bottles for sample collection
    b. Appropriate labels should be added via electrical tape
