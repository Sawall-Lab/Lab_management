...
Note: Be sure to wear gloves for the entire process! Testing for nutrient content is very sensitive.
...
-	Bottle with Nutrients Sampling (bottle modified for nutrient sampling)
    ...
    - Alternative bottles may be used
-	Amber bottles for sample collection
    - Appropriate labels should be added via tape
...
## <h3 id="#sample-collection">Sample Collection</h3>
