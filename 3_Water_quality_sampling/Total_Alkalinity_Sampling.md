...
Analysis of the TA samples is conducted using the Metrohm Titrator and the attached Tiamo software, located in room 305. The protocol for this process is outlined [here](../Total_Alkalinity_CO2/Metrohm_Titrator_&_Tiamo_Software.md).
