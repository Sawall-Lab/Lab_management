...
Analysis of the TA samples is conducted using the Metrohm Titrator and the attached Tiamo software, located in room 305. The protocol for this process is outlined [here](../3_Water_quality_sampling/Total_Alkalinity_CO3/Metrohm_Titrator_&_Tiamo_Software.md).
